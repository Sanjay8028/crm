    ...
    <div class="col-12">
      <section class="box ">
        <header class="panel_header">
          <h2 class="title float-left btn btn-danger">Trash Parties</h2>
                ...
                <div class="display-data-table-area">
                  <div class="table-responsive">
                    <table id="example-11" class="display table table-hover table-condensed dataTable no-foote" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
						$queryu ="SELECT *FROM tblleads where status='Trash'";
                        ...
                        <tr id="r-<?php echo $row['id']?>">
                          ...
                          <td><b style="font-size:14px"><?php echo $row['mobile']; ?></b></td>
                            <td><b style="font-size:14px"><?php echo $row['comment']; ?></b></td>
                              <td><b style="font-size:14px"><?php echo $row['assign_to']; ?></b></td>
                          <td style="display:inline-flex">
                              <a href="trash.php?did=<?php echo $row['id'];?>"><i class="fa fa-delete" title="Permanent Delete"><img src="https://play-lh.googleusercontent.com/Si72P4Dn-_54FeMqGtnDOAOwYcHVIAnSzB8OpeYp8BTP0xNUx0S_G4Cv5rxhlNPK2CA" style="width:30px"></i></a> 
                          </td>
                        </tr>
                        <?php
						$i++;
