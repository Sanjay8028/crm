...
<header class="panel_header">
    <h2 class="title float-left btn btn-danger">Add Employee</h2>
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <p style="text-align: center;color:green;"><?php echo $error; ?></p>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">Name</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">User Type</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">User Name</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">Password</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">PF Account No</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">ESI Number</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">Date of Joining</label>
        ...
        <div class="form-group col-12 col-md-4 col-lg-4">
            <label class="form-label btn btn-info form-control">Permission</label>
