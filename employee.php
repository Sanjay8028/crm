...
<header class="panel_header">
    <h2 class="title float-left btn btn-danger">All Employee</h2>
  ...
  <div class="table-responsive">
    ...
    <tbody>
        ...
        <td class="clr-blue"><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id']; ?>" class="checkBoxClass"></td>
            <td><b style="font-size:14px"><?php echo 'WI-'.$row['employee_id']; ?></b></td>
            ...
            <td><b style="font-size:14px"><?php echo $row['salary']; ?></b></td>
            <td><b style="font-size:14px"><?php echo $row['regdate']; ?></b></td>
            <td style="display:inline-flex">
            <a href="update-empolyee.php?id=<?php echo $row['id'];?>"><i class="fa fa-penc" title="Edit"> <img src="https://png.pngtree.com/png-vector/20190114/ourlarge/pngtree-vector-pencil-icon-png-image_313118.jpg" style="width:30px;float:left"></i></a>
            </td>
        </tr>
        <?php
        $i++;
