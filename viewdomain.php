    ...
    <div class="col-12">
      <section class="box ">
        <header class="panel_header">
          <h2 class="title float-left btn btn-danger">All Domain Details</h2>
                    ...
                    <table id="example-11" class="display table table-hover table-condensed dataTable no-foote" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr id="r-<?php echo $row['id']?>">
                          ...
                          <td><b style="font-size:14px"><?php echo $row['dname']; ?></b></td>
                          <td><b style="font-size:14px"><?php echo $row['cname']; ?></b></td>
                          <td><b style="font-size:14px"><?php echo $row['status']; ?></b></td>
                          <td><b style="font-size:14px"><?php echo $row['plan']; ?></b></td>
                          <td><b style="font-size:14px"><?php echo $row['bdate']; ?></b></td>
                           <td><b style="font-size:14px"><?php echo $row['edate']; ?></b></td>
                          <td style="display:inline-flex">
                              <a href="update-domain.php?id=<?php echo $row['id']; ?>"><i class="fa fa-penc" title="Edit"> <img src="https://png.pngtree.com/png-vector/20190114/ourlarge/pngtree-vector-pencil-icon-png-image_313118.jpg" style="width:30px;float:left"></i></a> 
