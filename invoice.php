...
<body>
   ...
   <!-- margin-right: 225px;"><button onclick="window.print()">Print</button></p>-->
    ...
    <table width="100%" style="font-family: sans-serif;">
        <tr>
            <td width="100%" style="text-align: center; font-size: 20px; font-weight: bold; padding: 0px;"><h2 class="text-center title-h2">Performa Invoice</h2></td>
        </tr>        
    </table>
