...
<section id="main-content">
    <section class="wrapper main-wrapper" style=''>
        ...
        <section class="box" >
            <header class="panel_header">
                <h2 class="title float-left btn btn-danger">Todays Contact</h2>
	...
	<form method="POST" action="" enctype="multipart/form-data">			
	<div class="row">
	<div class="col-lg-12 col-md-12 col-12"><hr/><h5 style="color:#ff8080">Filter Lead By Daily Basis, Monthly Basis and Yearly Basis</h5><hr/></div>
	<div class="col-lg-3 col-md-3 col-12">
                    ...
                    <table id="example-11" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <!--<td class="clr-blue"><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<php echo $row['id']; ?>" class="checkBoxClass"></td>-->
                                ...
                                <td><b style="font-size:12px;text-transform: uppercase;"><?php echo $row['company_name']; ?></b></td>
                                <td><b style="font-size:12px;text-transform: uppercase"><?php echo $row['client_name']; ?></b></td>
                                <td><b style="font-size:12px;text-transform: uppercase;"><?php echo $row['email']; ?> </b></td>
                                
                                <td><b><?php echo $row['mobile']; ?></b></td>
                    
                                <td><b style="font-size:12px;text-transform: uppercase"><?php echo $row['assign_to']; ?></b></td>
                                <td><b style="color:red"><?php echo substr($rows['remark'], 0, 15); ?></b></td>
