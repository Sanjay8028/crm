...
if(isset($_POST['submit']))
{
   ...
   $qu="Insert Into tblinvoice (uid,invoice_no,service_name,amount,gst,gst_amount,subtotal,invoice_date,invoice_time,gst_no,state,company_name,mobile,email,address) 
    Values('".$rowqs['id']."','".addslashes($_POST['invoice_no'])."','".addslashes($_POST['service'])."','".$amount."',
...
<div class="col-12">
<section class="box ">
<header class="panel_header"><h2 class="title float-left">Generate Invoice</h2></header>
...
<form action="" method="POST">
    ...
    <div class="col-12 col-md-9 col-lg-8 padding-bottom-30">
        <div class="text-left">
            <button type="submit" class="btn btn-primary" name="submit">GENERATE INVOICE</button>
