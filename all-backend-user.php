    ...
    <section class="wrapper main-wrapper" style=''>
        ...
        <section class="box">
            <header class="panel_header">
                <h2 class="title float-left btn btn-success">ALL Backend Employee</h2>
            ...
            <div class="display-data-table-area">
                <div class="table-responsive">
                    <table id="example-11" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                        ...
                        <tbody>
                           <?php
							$queryu ="SELECT *FROM tblusers where user_type='Backend'";
							...
							<tr id="r-<?php echo $row['id']?>">
							   <td class="clr-blue"><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id']; ?>" class="checkBoxClass"></td>
								...
								</td> <!--view-teamleader.php?uid=<php echo $row['username']; ?> -->
								<td><b style="font-size:14px"><a href="" style="color:#3F51B5 !important; background:none;"><?php echo $row['name']; ?></a></b></td>
								...
								&nbsp;
								<a href="backendupdate-empolyee.php?id=<?php echo $row['id'];?>"><i class="fa fa-boo" title="Read More"><img src="https://i.pinimg.com/originals/d9/62/3f/d9623fc777b7498ab50cb37520975ef5.png" style="width:30px;float:left"></i></a>
								
								<a href="all-backend-user.php?did=<?php echo $row['id'];?>"><i class="fa fa-boo" title="Read More"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqdV_TgwjyVgB6KDmAJGN3oT9XTME0sflargbMBwODuYwJA19RDXRS0aDEtDkXmZdL2aU&usqp=CAU" style="width:30px;float:left"></i></a> 
								 <a href="all-backend-user.php?sid=<?php echo $row['id'];?>&status=<?php echo $row['status']?>" class="btn btn-info">Status </a>
